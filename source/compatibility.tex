...
\rSec2[diff.cpp11.special]{Clause \ref{special}: special member functions}
...
\effect
Valid \CppXIV code may fail to compile in this International Standard;
it is now necessary to explicitly initialize the base class
